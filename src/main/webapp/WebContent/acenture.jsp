	...
	<tr>
		<td width= "35%" VALIGN=top>
			...
			<table class="table table-sm table-bordered table-striped">
				...
				<table align="center">
					...
					<td class="letra ocultar" id="trailerTD" style="width: 350px; margin-left: 40px;"align="right"><input id="trailer" type="checkbox" class="form-check-input" onchange="OpcionCuracreto();" value=""><b>Cancún Cancún Cancún Cancún Cancún</b></td><!-- trailer curacreto -->
					<td class="letra ocultar" id="torthonTD" style="width: 350px; margin-left: 40px;"align="right"><input id="torthon" type="checkbox" class="form-check-input" onchange="OpcionCuracreto();" value=""><b>Mérida Mérida Mérida Mérida</b></td><!-- torthon curacreto-->
		...
		<td width= "35%" VALIGN=top>
			...
			<table class="table table-sm table-bordered table-striped">
				...
				<tr>
					<td class="letra" style="width: 300px;"align="right"><b>Recuperación Recuperación de Evidencia  Recuperación Recuperación de Evidencia$</b></td>
